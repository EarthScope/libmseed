 ...
 *
 * Sets global header for URL-based requests generated by the library.
 * The API exists and will return an error when the library was not
 * built with URL support.
 *
